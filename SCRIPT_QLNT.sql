...
CREATE TABLE HOADON (
	MA_HOADON INT NOT NULL primary key,
...
CREATE TABLE DONDATTHUOC (
	MA_DONDAT INT NOT NULL PRIMARY KEY,
	MA_NHANVIEN VARCHAR(10) NOT NULL,
...
--khach hang
INSERT KHACHHANG(MA_KHACHHANG,TEN_KHACHHANG,GIOI_TINH,KH_NGAYSINH,SDT_KHACHHANG,BENH_LI) VALUES 
...
(2021000,'NV00000000','NCC0000000','20210508')
--(2021001,N'AD00000000','NCC0000001','20210508'),
--(2021002,N'AD00000000','NCC0000002','20200605'),
--(2021003,N'AD00000000','NCC0000001','20191215'),
--(2021004,N'AD00000000','NCC0000003','20210605')

--CT ĐƠN ĐẶT
--INSERT CT_DONDAT(MA_DONDAT,MA_THUOC,SL_DAT) VALUES
--(2021001,N'DQG0000035',5),
--(2021002,N'DQG0000035',10),
--(2021002,N'DQG0000030',20),
--(2021003,N'DQG0000035',5),
--(2021004,N'DQG0000011',14),
--(2021004,N'DQG0000030',2)

--HÓA ĐƠN
INSERT HOADON(MA_HOADON,MA_KHACHHANG,MA_NHANVIEN,NGAY_LAP,TONG_TIEN) VALUES
(2021000,'KH00000000','NV00000000','20211026',NULL)
--(2021001,'KH00000001','NV00000004','20211026',NULL),
--(2021002,'KH00000004','NV00000004','20211026',NULL),
--(2021003,'KH00000004','NV00000004','20211026',NULL),
--(2021004,'KH00000004','NV00000005','20211026',NULL),
--(2021005,'KH00000005','NV00000005','20211026',NULL)
--CT HÓA ĐƠN
--INSERT CT_HOADON(MA_HOADON,MA_THUOC,SO_LUONG,THANH_TIEN) VALUES 
--(2021001,'DQG0000030',3,NULL),
--(2021002,'DQG0000012',1,NULL),
--(2021002,'DQG0000020',1,NULL),
--(2021003,'DQG0000015',2,NULL),
--(2021003,'DQG0000016',3,NULL),
--(2021004,'DQG0000017',4,NULL)


--dang nhap

INSERT DANGNHAP VALUES ('admin','admin',1,'AD00000000',N'Hoạt động',1,1,1,1,1,1,1)
--INSERT DANGNHAP VALUES ('user1','user1',2,'NV00000001',N'Đã đóng',1,1,1,1,1,1,1);
...
UPDATE DANGNHAP SET PQ_THUOC = 0, PQ_NHANVIEN = 0, PQ_KVLT = 0, PQ_KHACHHANG = 0, PQ_NCC = 0, PQ_HOADON = 0, PQ_DONDATTHUOC = 0 where(TAIKHOAN = 'NV00000008') 
--XEM THÔNG TIN
...
Select GIA_BAN from THUOC where TEN_THUOC = 'Thevapop'

update HOADON set MA_KHACHHANG = 'KH00000000', TONG_TIEN = 312000 where MA_HOADON = 2021001

select format(Sum(THANH_TIEN), int) AS TONG_TIEN from CT_HOADON where MA_HOADON = 2021001
Select * From DANGNHAP Where TAIKHOAN = 'user1' and TRANG_THAI = 'Đã Đóng'